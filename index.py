...
name_frame = LabelFrame(ScoreButtonFrame,text="Player Name",font=('arial',12,'bold'),fg='black',bd=10,width=540,height=110, relief=RAISED,padx=10,pady=2 )
...
btnNewGame = tkinter.Button(ActionFrame, text="New Game", font=('arial',20,"bold"),bd=5, borderwidth = 4, relief ="solid", command = startNewGame).place(x=0,y=3, width=249,height=100 )
